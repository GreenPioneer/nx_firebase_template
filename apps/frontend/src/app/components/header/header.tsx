        ...
        <nav className="relative z-50 flex justify-between">
          <div className="flex w-full flex-wrap items-center justify-between px-3">
            ...
            <div className="flex items-center px-2">
              <span className="block transition duration-150 ease-in-out lg:p-2">
                Sign into your account:
              </span>
              {hasAdminAccess && (
                <div
                  className="relative flex-shrink-0 z-50 mr-10"
                  ref={adminContainer}
                >
                  <div>
                    <button
                    ...
                    >
                      <NavLink
                        ...
                        className={`block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 ${
                          currentHeader === 'admin' ? 'bg-gray-100' : ''
                        }`}
                      >
                        Admin Page
                      </NavLink>
                ...
                >
                  ...
                  >
                    <NavLink
                      ...
                      to="/account"
                      className={`block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 ${
                        currentHeader === 'account' ? 'bg-gray-100' : ''
                      }`}
                    >
            ...
            <div className="lg:hidden w-full" id="mobile-menu">
              <div className="pt-2 pb-3 space-y-1 w-full">
                <NavLink
                  ...
                  aria-current={'home' === currentHeader ? 'page' : undefined}
                  role="menuitem"
                >
                  Home
                </NavLink>
                <NavLink
                  ...
                  aria-current={'blogs' === currentHeader ? 'page' : undefined}
                  role="menuitem"
                >
                  Blogs
                </NavLink>
